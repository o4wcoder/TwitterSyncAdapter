...
public class TwitterOauthHelper {
    private static final String CONSUMER_KEY = "EvTi12KC9V2Dkbm9OUakF3vsw";
    private static final String CONSUMER_SECRET = "1ERxgepYgDBW8WaBV9aZbMSKLQH584iuODNGlrpgqdUV1ab4rc";
